...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}r <{\hskip -3pt} !{\foo} >{}X@{}}
        \addlinespace[1.5ex]
        & \textbf{Software Development Engineer II} \hfill \textit{Dec. 2025 to Present}
        \parbox{\textwidth}{\textit{Amazon DynamoDB (Operational Intelligence)}}
        ...
        \end{itemize} \\
        & \textbf{Software Development Engineer I} \hfill \textit{Sep. 2023 to Nov. 2025}
        \parbox{\textwidth}{\textit{Amazon DynamoDB (Console then Operational Intelligence from Mar. 2025)}}
        \begin{itemize}[topsep=5pt]
        ...
        \parbox{\textwidth}{\textit{Amazon DynamoDB (Console)}}
        \begin{itemize}[topsep=5pt]
